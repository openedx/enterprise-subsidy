    ...
    def outer_wrapper(view):
        ...
        def wrapper(request, *args, **kwargs):
            ...
            if not requirement_satisfied:
                missing_params = ', '.join(query_parameter_names)
                raise ValidationError(
                    detail=f'You must provide at least one of the following query parameters: {missing_params}.'
                )
